---
title: "Competition and ESG practices in emerging markets"
date: 2021-04-05
...
## But in Emerging Markets {.smaller}
...
## Shock in Competition: Brazil 2015 {.smaller}
...
## Main Results (Model 2 - pre-matching) {.smaller}
...
## Main Results (Model 2 - post-matching) {.smaller}
...
## Main Results (Robustness and Falsification) {.smaller}
...
## Placebo tests (alternative Y's) {.smaller}
