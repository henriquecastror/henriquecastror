---
title: "Module 9:  Numeric Questions"
---
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module9_num_q1.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module9_num_q2.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module9_num_q3.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module9_num_q4.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module9_num_q5.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module9_num_q6.qmd" >}}
  </div>
</div>
:::
