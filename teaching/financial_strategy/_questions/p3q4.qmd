...
`r fitb( round( (w1 * r1 + w2 * r2) ,3) , tol=0.01)`
...
`r fitb( round( w1^2 * sigma1^2 + w2^2 * sigma2^2 + 2 * w1 * w2 * correl * sigma1 * sigma2  ,3) , tol=0.01)`
...
`r fitb( round( sqrt(w1^2 * sigma1^2 + w2^2 * sigma2^2 + 2 * w1 * w2 * correl * sigma1 * sigma2 ) ,3) , tol=0.01)`
...
::: {.callout-important}
**Type your answers with "." instead of ","! For numerical answers in percent values, use 2 decimal places. For instance, if your answer is 0.12345 or 12.345%, type, "12.34" in the box.**
:::
...
1) `r round( (w1 * r1 + w2 * r2) ,3) `

2) `r round( w1^2 * sigma1^2 + w2^2 * sigma2^2 + 2 * w1 * w2 * correl * sigma1 * sigma2  ,3) `

3) `r round( sqrt(w1^2 * sigma1^2 + w2^2 * sigma2^2 + 2 * w1 * w2 * correl * sigma1 * sigma2 ) ,3) `
