...
labs(y='Cumulative return (daily)') + theme_solarized() +
  ggtitle("Cumulative Returns  CDI, Ibov, and Selic (1995-2023)")
ggplotly(p)
```
...
#api_key = "kfqxH5NsN8Nhe_U1NADB"
quandl.ApiConfig.api_key = 'kfqxH5NsN8Nhe_U1NADB'
```
...
plt.title('Cumulative Returns  CDI, Ibov, and Selic (1995-2023)', fontsize=15)
...
labs(y='Cumulative return (daily)') + theme_solarized() +
  ggtitle("Cumulative Returns CDI, Ibov, Selic, and Inflation (1995-2023)")
ggplotly(p)
```
...
ax.plot(df["ref_date"], df["Ibov_return"], label='Ibov')
ax.plot(df["ref_date"], df["selic_return"], label='Selic')
ax.plot(df["ref_date"], df["inf_return"], label='Inflation')
plt.ylabel('Cumulative return (daily)', fontsize=13)
plt.title('Cumulative Returns  CDI, Ibov, Selic, and Inflation (1995-2023)', fontsize=15)
plt.xlabel('Date', fontsize=13)
plt.legend(loc='upper left')
plt.show()
```
...
[Question](https://hcm.quarto.pub/ef_p2q/#expected-return){preview-link="true"}
...
[Question](https://hcm.quarto.pub/ef_p2q/#question-8){preview-link="true"}
...
## Equity Risk Premium (ERP) {.smaller background="#f2f7ba" }

Let's plot the Equity Risk Premium. I am extracting the data from this [website](https://ceqef.fgv.br/node/594).
...
#| code-line-numbers: true
#| eval: true
url <- "https://ceqef.fgv.br/sites/ceqef.fgv.br/files/serie_de_equity_risk_premium_3.xls"
