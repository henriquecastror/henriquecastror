...
Now, let's compute the average return of a portfolio with 40% invested in A and the remaining 60% invested in B. **The portfolio return is the average return of the assets**.
...
**Correlations are different. Sorry, I can't figure why! If you can, let me know.** 
...
## 11.7 The CAPM {.smaller background="#c9f7ba" visibility="hidden"}
...
## 11.8 Determining the Risk Premium {.smaller background="#FFFA9A" visibility="hidden"}
