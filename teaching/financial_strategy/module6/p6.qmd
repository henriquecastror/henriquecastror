...
<div data-ticket
     ...
     data-session="module6_checkout1"
     data-page="module6_checkout1"
     data-require-login="true"
     data-open="2025-10-06 16:30"
     data-close="2025-10-06 16:59">
</div>
...
[Tesouro Direto](https://www.tesourodireto.com.br/produtos/dados-sobre-titulos/rendimento-dos-titulos)
...
## {.smaller background="#FFD6A4" visibility="hidden"}
...
##  {.smaller  background="#FFFFFF" visibility="hidden"}
...
<div data-ticket
     data-bridge="https://course-chat.hcmrtns.workers.dev/checkouts"
     data-session="module6_checkout2"
     data-page="module6_checkout2"
     data-require-login="true"
     data-open="2025-10-08 16:00"
     data-close="2025-10-08 16:59">
</div>
...
<div style="font-family: sans-serif; display: flex; flex-direction: column; align-items: center; gap: 16px; margin-top: 30px;">
  ...
  <a href="https://henriquemartins.net/teaching/financial_strategy/module6/p6tf.html" target="_blank"
  ...
  <a href="https://henriquemartins.net/teaching/financial_strategy/module6/p6num.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    🔢 Numeric Questions
  </a>

  <a href="https://henriquemartins.net/teaching/financial_strategy/module6/p6mcq.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    📝 Multiple Choice
  </a>

  <a href="https://henriquemartins.net/teaching/financial_strategy/module6/p6long.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    ✍️ Long-form Answers
  </a>
