...
<form onsubmit="event.preventDefault();" style="display: flex; flex-direction: row; gap: 6px;">
  <span><strong>1. How much did the company raise in Series A?</strong></span>
...
::: {.question-block}
<form onsubmit="event.preventDefault();" style="display: flex; flex-direction: row; gap: 6px;">
  <span><strong>2. How much did the company raise in Series B?</strong></span>
...
::: {.question-block}
<form onsubmit="event.preventDefault();" style="display: flex; flex-direction: row; gap: 6px;">
  <span><strong>3. How much did the company raise in Series C?</strong></span>
...
::: {.question-block}
<form onsubmit="event.preventDefault();" style="display: flex; flex-direction: row; gap: 6px;">
  <span><strong>4. What % of shares did founders keep after Series A?</strong></span>
...
::: {.question-block}
<form onsubmit="event.preventDefault();" style="display: flex; flex-direction: row; gap: 6px;">
  <span><strong>5. What % of shares did founders keep after Series B?</strong></span>
...
::: {.question-block}
<form onsubmit="event.preventDefault();" style="display: flex; flex-direction: row; gap: 6px;">
  <span><strong>6. What % of shares did founders keep after Series C?</strong></span>
