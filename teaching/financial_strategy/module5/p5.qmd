...
subtitle: ' **Module 5 - ch.13 Investor Behavior and Capital Market Efficiency** '
author:
...
## 13.1 Competition & Cap. Markets {.smaller background="#c9f7ba"}
...
## 13.2 Info. & Rational Expect. {.smaller background="#f2f7ba"}
...
## 13.3  Behavior of Indiv. Investors {.smaller background="#f5d5d5"}
...
## 13.3 Behavior of Indiv. Investors {.smaller background="#f5d5d5" visibility="hidden"}
...
<div data-ticket
     ...
     data-session="module5_checkout1"
     data-page="module5_checkout1"
     data-require-login="true"
     data-open="2025-09-15 16:30"
     data-close="2025-09-15 16:59">
</div>
...
## 13.5  Efficiency of  Market Portfolio  {.smaller  background="#cff5ce" }
...
<input type="hidden" 
       id="slide-id" 
       value="module5_num_qu1"
       data-open="2025-09-17 16:00"
       data-close="2025-09-17 16:59">
:::

{{< include "../submit-to-sheets2.html" >}}

::: panel-tabset

# (1)

{{< include "num/module5_num_q1_class.qmd" >}}


# (2)

{{< include "num/module5_num_q6_class.qmd" >}}
...
<div data-ticket
     data-bridge="https://course-chat.hcmrtns.workers.dev/checkouts"
     data-session="module5_checkout2"
     data-page="module5_checkout2"
     data-require-login="true"
     data-open="2025-09-16 16:30"
     data-close="2025-09-17 16:59">
</div>
...
If a stock went up yesterday, that fact alone does not tell you anything reliable about what will happen tomorrow.
...
If past information were useful, investors could make “easy money” by spotting patterns.

But in competitive markets, many traders would immediately exploit such patterns, pushing prices to adjust instantly.

Result: the opportunity disappears, leaving only a random walk.
...
- This includes financial reports, press releases, macroeconomic data, analyst reports, and anything that is publicly available.

- In this view, stock prices adjust quickly and completely to new information.

Example: when a company announces unexpectedly strong earnings, its stock price jumps almost immediately to a new level that reflects the news.
...
- It means you cannot systematically “beat the market” by analyzing public information, because by the time you trade, the market has already incorporated it.

- Fundamental analysis (studying P/E ratios, growth forecasts, etc.) should not consistently produce abnormal returns, since prices already reflect such data.

- To outperform, you would need access to private or inside information (which raises legal/ethical issues).
...
- In this extreme version, even insiders with access to privileged data could not systematically earn excess returns, because the market would already have incorporated that information into prices.

- This implies that nobody can consistently “beat the market,” regardless of skill or access to data.

. . . 

**Strong efficiency does not mean investors earn zero returns.**

It means they earn a return associated with risk (as predicted by CAPM or other risk–return models).

Abnormal returns should not be possible on a consistent basis, even for insiders.
...
## Semistrong efficiency {.smaller background="#FFFA9A" }
...
## Strong efficiency {.smaller background="#FFFA9A" }
...
## Are markets efficient? [Video](https://www.youtube.com/watch?v=bM9bYOBuKF4) {.smaller background="#FFFA9A" }
...
## Bubbles {.smaller background="#FFFA9A" }

**How can we explain bubbles?** [Link](https://pt.wikipedia.org/wiki/Mania_das_tulipas)
...
<div data-ticket
     data-bridge="https://course-chat.hcmrtns.workers.dev/checkouts"
     data-session="module5_checkout3"
     data-page="module5_checkout3"
     data-require-login="true"
     data-open="2025-09-22 16:30"
     data-close="2025-09-22 16:59">
</div>
...
<div style="font-family: sans-serif; display: flex; flex-direction: column; align-items: center; gap: 16px; margin-top: 30px;">
  ...
  <a href="https://henriquemartins.net/teaching/financial_strategy/module5/p5tf.html" target="_blank"
  ...
  <a href="https://henriquemartins.net/teaching/financial_strategy/module5/p5num.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    🔢 Numeric Questions
  </a>

  <a href="https://henriquemartins.net/teaching/financial_strategy/module5/p5mcq.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    📝 Multiple Choice
  </a>

  <a href="https://henriquemartins.net/teaching/financial_strategy/module5/p5long.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    ✍️ Long-form Answers
  </a>
