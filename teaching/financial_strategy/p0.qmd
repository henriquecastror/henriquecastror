...
format:
  revealjs: 
    ...
    css: logo.css
    footer: '**[**Henrique C. Martins**] [[henrique.martins@fgv.br](mailto:henrique.martins@fgv.br)] [[Teaching Resources](https://henriquemartins.net/teaching/financial_strategy/)]  [[Interact](https://henriquemartins.net/teaching/financial_strategy/p0.html#/interact)][Do not use without permission]**  '
    multiplex: true
    scrollable: true
...
3 Participation: **20%**
  ...
  - Interacting on slides
  - "Monitored activity" (three) 
...
- [Questions T/F](https://henriquemartins.net/teaching/financial_strategy/p1tf.html){preview-link="true"} 
- [Questions Numeric](https://henriquemartins.net/teaching/financial_strategy/p1num.html){preview-link="true"} 
