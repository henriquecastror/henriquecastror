...
format:
  revealjs: 
    ...
    include-after-body: ../chat-widget.html
    touch: true
    controls: true
    slide-number: true
    theme: simple
    ...
    css: logo.css
    footer: '<span style="font-size:16px">**[**Henrique C. Martins**] [[henrique.martins@fgv.br](mailto:henrique.martins@fgv.br)] [[Teaching Resources](https://henriquemartins.net/teaching/financial_strategy/)][Do not use without permission]**</span>'
    scrollable: true
...
include-after: |
  <script>
    ...
    window.VHCM.module = "module3";   // <<< define o módulo AQUI
