...
format:
  revealjs: 
    ...
    css: logo.css
    footer: '**[**Henrique C. Martins**] [[henrique.martins@fgv.br](mailto:henrique.martins@fgv.br)] [[Teaching Resources](https://henriquemartins.net/teaching/financial_strategy/)] [Practice [T/F](https://henriquemartins.net/teaching/financial_strategy/p2tf.html) & [Numeric](https://henriquemartins.net/teaching/financial_strategy/p2num.html)] [[Interact](https://henriquemartins.net/teaching/financial_strategy/p2.html#/interact)][Do not use without permission]**  '
    multiplex: true
    scrollable: true
...
- [Questions T/F](https://henriquemartins.net/teaching/financial_strategy/p2tf.html){preview-link="true"} 
- [Questions Numeric](https://henriquemartins.net/teaching/financial_strategy/p2num.html){preview-link="true"} 
