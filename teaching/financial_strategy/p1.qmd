...
format:
  revealjs: 
    ...
    css: logo.css
    footer: '**[**Henrique C. Martins**] [[henrique.martins@fgv.br](mailto:henrique.martins@fgv.br)] [[Teaching Resources](https://henriquemartins.net/teaching/financial_strategy/)] [Practice [T/F](https://henriquemartins.net/teaching/financial_strategy/exams/p1tf.html) & [Numeric](https://henriquemartins.net/teaching/financial_strategy/exams/p1num.html)] [[Interact](https://henriquemartins.net/teaching/financial_strategy/part_1.html#/interact)][Do not use without permission]**  '
    multiplex: false
    scrollable: true
