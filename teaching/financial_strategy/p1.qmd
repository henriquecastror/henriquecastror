...
format:
  revealjs: 
    ...
    css: logo.css
    footer: '**[**Henrique C. Martins**] [[henrique.martins@fgv.br](mailto:henrique.martins@fgv.br)] [[Teaching Resources](https://henriquemartins.net/teaching/financial_strategy/)] [Practice [T/F](https://henriquemartins.net/teaching/financial_strategy/p1tf.html) & [Numeric](https://henriquemartins.net/teaching/financial_strategy/p1num.html)] [[Interact](https://henriquemartins.net/teaching/financial_strategy/p1.html#/interact)][Do not use without permission]**  '
    multiplex: false
    scrollable: true
...
# {.smaller .scrollable background="#ead1dc" }

::: {style="font-size: 40%; text-align: right;"}
Key: *slide1-temaA*
<input type="hidden" id="slide-id" value="slide1-temaA">
:::

{{< include "_questions/question1.qmd" >}}

<hr style="border: none; border-top: 2px dashed #999; margin: 20px 0;">

{{< include "_questions/question2.qmd" >}}

<hr style="border: none; border-top: 2px dashed #999; margin: 20px 0;">

{{< include "_questions/question3.qmd" >}}
