...
format:
  revealjs: 
    ...
    css: logo.css
    footer: '**[**Henrique C. Martins**] [[henrique.martins@fgv.br](mailto:henrique.martins@fgv.br)] [[Teaching Resources](https://henriquemartins.net/teaching/)] [[Comments](https://henriquemartins.net/teaching/financial_strategy/part_1.html#/comments)][[Exams](https://henriquemartins.net/teaching/financial_strategy/exams/p1tf.html)]**  '
    multiplex: true
    scrollable: true
...
<iframe height="80%" width="100%" src="https://henriquemartins.net/teaching/financial_strategy/exams/p1tf.html#part-1-ch24"> </iframe>
...
## Practice {.smaller background="#a2bef5"}


::: {.callout-important}
Remember to solve the [problems](https://henriquemartins.net/teaching/financial_strategy/exams/p1tf.html){preview-link="true"}. If you have any questions, ask next slide  
:::

## Comments? {.smaller background="#a2bef5"}
