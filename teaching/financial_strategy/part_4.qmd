...
- Dow Jones Industrial Average (DJIA)
  - A price-weighted portfolio of 30 large industrial stocks (holds an equal number of shares of each stock).
- Ibov
  - Around 70 BR stocks. Follows an algorithm focusing on liquidity.

. . .

ETFs (Exchange-traded funds)

- A portfolio that follows an index, like the SP500. 
...
Finally, we can estimate Beta using the formula:
