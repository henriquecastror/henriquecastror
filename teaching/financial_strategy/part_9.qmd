...
format:
  revealjs: 
    ...
    css: logo.css
    footer: ' **[**Henrique C. Martins**] [[henrique.martins@fgv.br](mailto:henrique.martins@fgv.br)] [[Teaching Resources](https://henriquemartins.net/teaching/)] [[Comments](https://henriquemartins.net/teaching/financial_strategy/part_9.html#/comments)]** '
    multiplex: true
    scrollable: true
...
# 16.1 Default and Bankruptcy in Perf. Mkt {visibility="hidden"}
...
# 16.2 Bankruptcy Costs & Fin. Distress {visibility="hidden"}
...
# 16.3 Fin. Distress  Costs and Value {visibility="hidden"}
...
# 16.4 The Tradeoff Theory {visibility="hidden"}
...
# 16.5 The Agency Costs of Leverage {visibility="hidden"}
...
# 16.6 The Agency Benefits of Leverage {visibility="hidden"}
...
# 16.7 Agency Costs and the TT {visibility="hidden"}
...
# 16.8 Asymmetric Info. and Cap. Struc. {visibility="hidden"}
...
#  16.9 The Bottom Line {visibility="hidden"}
...
<iframe  height="50%" width="100%" src="https://hcm.quarto.pub/p9q1/"></iframe>

##  {.smaller background="#522f31"}

**Question 2 **

<iframe  height="50%" width="100%" src="https://hcm.quarto.pub/p9q2/" ></iframe>
...
<iframe  height="50%" width="100%" src="https://hcm.quarto.pub/p9q3/" ></iframe>

##  {.smaller background="#522f31"}

**Question 4 **

<iframe  height="50%" width="100%" src="https://hcm.quarto.pub/p9q4/" ></iframe>

##  {.smaller background="#522f31"}

**Question 5 **

<iframe  height="50%" width="100%" src="https://hcm.quarto.pub/p9q5/" ></iframe>

##  {.smaller background="#522f31"}

**Question 6 **

<iframe  height="50%" width="100%" src="https://hcm.quarto.pub/p9q6/" ></iframe>

##  {.smaller background="#522f31"}

**Question 7 **

<iframe  height="50%" width="100%" src="https://hcm.quarto.pub/p9q7/" ></iframe>
...
<script src="https://giscus.app/client.js"
        data-repo="henriquecastror/efcomments-part-9"
        data-repo-id="R_kgDOK8EAXA"
        data-category-id="DIC_kwDOK8EAXM4Cb5Ga"
