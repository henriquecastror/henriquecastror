...
format:
  revealjs: 
    ...
    css: logo.css
    footer: ' <div data-lyket-type="like" data-lyket-id="my-first-post" style="font-size: 14px" ></div> **[**Henrique C. Martins**] [[henrique.martins@fgv.br](mailto:henrique.martins@fgv.br)] [[Teaching Resources](https://henriquemartins.net/teaching/)] [[Comments](https://henriquemartins.net/teaching/financial_strategy/part_1.html#/comments)]**  '
    multiplex: true
    scrollable: true
