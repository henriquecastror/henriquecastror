---
title: "Module 10:  Long Answer Questions"
---
...
<script>
  const SLIDE_ID = "module10_p10long";
</script>
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "long/module10_long_q1.qmd" >}}
  </div>
</div>
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "long/module10_long_q2.qmd" >}}
  </div>
</div>
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "long/module10_long_q3.qmd" >}}
  </div>
</div>
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "long/module10_long_q4.qmd" >}}
  </div>
</div>
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "long/module10_long_q5.qmd" >}}
  </div>
</div>
