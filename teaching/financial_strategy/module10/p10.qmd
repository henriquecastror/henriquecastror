...
## 17.2 Dividends vs.  Repurchases {.smaller  background="#eeffff"}
...
## 17.2 Dividends vs.  Repurchases {.smaller  background="#eeffff" visibility="hidden"}
...
## 17.2 Dividend Policy Irrelevance {.smaller  background="#eeffff"}
...
#  17.3 Dividends Tax Disadvantage   {.smaller  background="#ead1dc"}
...
- Internationally, dividends are typically taxed at a higher rate than capital gains. In fact, long-term investors can defer the capital gains tax forever by not selling.
...
## 17.4 Dividend & Tax Clienteles {.smaller  background="#FFF3A6"}
...
## 17.4 Dividend & Tax Clienteles  {.smaller  background="#FFF3A6" visibility="hidden"}
...
<div data-ticket
     ...
     data-session="module10_checkout1"
     data-page="module10_checkout1"
     data-require-login="true"
     data-open="2025-11-17 16:30"
     data-close="2025-11-17 16:59">
</div>
...
# 17.5 Payout Vs. Retention of Cash {.smaller  background="#cfd5ea"}
...
## 17.5 Payout Vs. Retention of Cash {.smaller  background="#cfd5ea" visibility="hidden"}
...
## 17.7 Stock Dividends {.smaller  background="#ead1dc"}
...
## 17.7  Splits {.smaller  background="#ead1dc"}
...
## 17.7  Spin-Offs {.smaller  background="#ead1dc"}
...
<div data-ticket
     data-bridge="https://course-chat.hcmrtns.workers.dev/checkouts"
     data-session="module10_checkout2"
     data-page="module10_checkout2"
     data-require-login="true"
     data-open="2025-11-19 16:30"
     data-close="2025-11-19 16:59">
</div>
...
<div style="font-family: sans-serif; display: flex; flex-direction: column; align-items: center; gap: 16px; margin-top: 30px;">
  ...
  <a href="https://henriquemartins.net/teaching/financial_strategy/module10/p10tf.html" target="_blank"
  ...
  <a href="https://henriquemartins.net/teaching/financial_strategy/module10/p10num.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    🔢 Numeric Questions
  </a>

  <a href="https://henriquemartins.net/teaching/financial_strategy/module10/p10mcq.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    📝 Multiple Choice
  </a>

  <a href="https://henriquemartins.net/teaching/financial_strategy/module10/p10long.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    ✍️ Long-form Answers
  </a>
