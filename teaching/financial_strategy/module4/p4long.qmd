...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "long/module4_long_q1.qmd" >}}
  </div>
</div>
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "long/module4_long_q2.qmd" >}}
  </div>
</div>
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "long/module4_long_q3.qmd" >}}
  </div>
</div>
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "long/module4_long_q4.qmd" >}}
  </div>
</div>
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "long/module4_long_q5.qmd" >}}
  </div>
</div>
