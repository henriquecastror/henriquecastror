...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module4_num_q1.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module4_num_q2.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module4_num_q4.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module4_num_q5.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module4_num_q6.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module4_num_q7.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module4_num_q8.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module4_num_q9.qmd" >}}
  </div>
</div>
:::
...
<div style="display: flex; align-items: start; gap: 8px;">
  ...
  <div style="flex: 1;">
    {{< include "num/module4_num_q10.qmd" >}}
  </div>
</div>
:::
