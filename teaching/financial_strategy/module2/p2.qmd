...
subtitle: ' **Module 2 - ch.10 Capital Markets and the Pricing of Risk** '
author:
...
## Ranking tokens {.smaller background="#f7f9fc" }

These actions count toward your participation grade. 

. . . 

- **flash_quiz_participate** — Submitted a quiz attempt on the slide. **(+1)**

. . .

- **answer_correct_numeric** — Correct numeric answer (within tolerance of 0.1). **(+2)**
- **answer_wrong_numeric** — Incorrect numeric answer. **(0)**

. . .

- **answer_correct_long** — Long-form answer manually graded as correct. **(+5)**
- **answer_submitted_long** — Submitted a long-form answer (recorded as not correct). **(0)**

. . .

- **answer_correct_tf** — Correct answer to a T/F question. **(+1)**
- **answer_wrong_tf** — Incorrect answer to a T/F question. **(0)**

. . .

- **answer_correct_mcq** — Correct answer to a MCQ. **(+1)**
- **answer_wrong_mcq** — Incorrect answer to a MCQ. **(0)**

. . .

- **exit_ticket** — Submitted the end-of-class reflection (Check-out). **(+1)**

. . .

- **got_it** — Reacted with a “Got it” to a slide. **(+1)**



<script>
  const pageId = "mod2_like1"; 
</script>

{{< include ../like-button2.html >}}
...
# 10.1 Risk & Return: Insights  {.smaller background="#f2f5ce"} 
...
## 10.2 Measures of Risk and Return {.smaller  background="#cff5ce" visibility="hidden"}
...
##  {.smaller background="#f7f9fc"}


::: {.callout-important title="**Heads-up:** I’ve reopened the checkouts from previous classes. 🎉"}
:::

- If your submission wasn’t saved previously, **you can now resubmit**.
- If the "Send" button is not available to you, **it means your previous checkout was saved successfully.** ✅
- **What’s new**: I upgraded the whole submission pipeline and backend capacity to handle peak traffic, so the issues from last time should be resolved. 🚀
...
<div data-ticket
     ...
     data-session="module2_checkout1"
     data-page="module2_checkout1"
     data-require-login="true"
     data-open="2025-08-20 00:00"
     data-close="2025-08-22 23:59">
</div>
...
Key: *module2_slide1*
<input type="hidden" id="slide-id" value="module2_slide1">
:::
...
{{< include "num/module2_num_q1_class.qmd" >}}

{{< include "num/module2_num_q11_class.qmd" >}}

{{< include "num/module2_num_q12_class.qmd" >}}
...
# 10.4 Tradeoff risk vs. return {.smaller  background="#f5d5d5" }
...
**Risk vs return of selected Brazilian stocks.** There seems to be line, but not really...
...
::: {style="font-size: 40%; text-align: right;"}
Key: *module2_slide2*
<input type="hidden" id="slide-id" value="module2_slide2">
:::

{{< include "mcq/module2_mcq_q11_class.qmd" >}}
...
<div data-ticket
     data-type="exit"
     data-bridge="https://script.google.com/macros/s/AKfycbw-kE6XjRr2Zi8QunbqYdw_nDrlI92lx-vi_tS5BPOGEo9gbx3HUdO0bgu2n1EmPSs/exec"
     data-session="module2_checkout2"
     data-page="module2_checkout2"
     data-require-login="true"
     data-open="2025-08-20 00:00"
     data-close="2025-08-22 23:59">
</div>
...
::: {style="font-size: 40%; text-align: right;"}
Key: *module2_slide3*
<input type="hidden" id="slide-id" value="module2_slide3">
:::

{{< include "mcq/module2_mcq_q12_class.qmd" >}}
...
##  Market Risk Premium {.smaller background="#f2f7ba" visibility="hidden"}
...
**Equity Risk Premium** ([ERP](https://ceqef.fgv.br/banco-de-dados)) 
...
#| code-line-numbers: true
#| eval: true
url <- "https://ceqef.fgv.br/sites/default/files/2025-07/Serie%20de%20Equity%20Risk%20Premium%20Junho.xlsx"
...
ax.text(0.5, -0.1, "Source:  https://ceqef.fgv.br/banco-de-dados", transform=ax.transAxes, ha="center")
plt.show()
```
...
::: {style="font-size: 40%; text-align: right;"}
Key: *module2_slide4*
<input type="hidden" id="slide-id" value="module2_slide4">
:::
...
<div data-ticket
     data-type="exit"
     data-bridge="https://script.google.com/macros/s/AKfycbw-kE6XjRr2Zi8QunbqYdw_nDrlI92lx-vi_tS5BPOGEo9gbx3HUdO0bgu2n1EmPSs/exec"
     data-session="module2_checkout3"
     data-page="module2_checkout3"
     data-require-login="true"
