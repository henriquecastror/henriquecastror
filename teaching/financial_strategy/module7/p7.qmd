...
{{< include "num/module7_num_q1.qmd" >}}


# NUM II

{{< include "num/module7_num_q2.qmd" >}}

# NUM III

{{< include "num/module7_num_q3.qmd" >}}

# NUM IV

{{< include "num/module7_num_q4.qmd" >}}


# NUM V

{{< include "num/module7_num_q5.qmd" >}}
...
<div style="font-family: sans-serif; display: flex; flex-direction: column; align-items: center; gap: 16px; margin-top: 30px;">
  ...
  <a href="https://henriquemartins.net/teaching/financial_strategy/module7/p7tf.html" target="_blank"
  ...
  <a href="https://henriquemartins.net/teaching/financial_strategy/module7/p7num.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    🔢 Numeric Questions
  </a>

  <a href="https://henriquemartins.net/teaching/financial_strategy/module7/p7mcq.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    📝 Multiple Choice
  </a>

  <a href="https://henriquemartins.net/teaching/financial_strategy/module7/p7long.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    ✍️ Long-form Answers
  </a>
