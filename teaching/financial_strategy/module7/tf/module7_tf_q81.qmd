...
<form onsubmit="event.preventDefault(); checkAnswerBox('module7_tf_q81','T')" style="display: flex; align-items: center; gap: 8px;">
  ...
  <label for="module7_tf_q81"><strong>If the risk-free rate is 3% and the market premium is 6%, a firm with βu=1.2 has an unlevered cost of capital of 10.2%.</strong></label>
</form>
