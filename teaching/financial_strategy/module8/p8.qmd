...
## 15.2 Valuing  Interest Tax Shield {.smaller background="#feffee"}
...
<div data-ticket
     ...
     data-session="module8_checkout1"
     data-page="module8_checkout1"
     data-require-login="true"
     data-open="2025-11-03 16:30"
     data-close="2025-11-03 16:59">
</div>
...
# 15.3 Recapitalization to Capture the Tax Shield  {.smaller background="#ead1dc"}

## 15.3  Capture the Tax Shield {.smaller background="#ead1dc"}
...
## 15.3  Capture the Tax Shield {.smaller background="#ead1dc" visibility="hidden"}
...
##  {.smaller background="#cfd5ea" visibility="hidden"}
...
## 15.5 Optimal Cap. Structure & Tax {.smaller  background="#eeffff"}
...
## 15.5  Optimal Cap. Structure & Tax  {.smaller  background="#eeffff" visibility="hidden"}
...
## Finally:  Low leverage puzzle {.smaller  background="#eeffff"}
...
<div data-ticket
     data-bridge="https://course-chat.hcmrtns.workers.dev/checkouts"
     data-session="module8_checkout2"
     data-page="module8_checkout2"
     data-require-login="true"
     data-open="2025-11-05 16:30"
     data-close="2025-11-05 16:59">
</div>
...
<div style="font-family: sans-serif; display: flex; flex-direction: column; align-items: center; gap: 16px; margin-top: 30px;">
  ...
  <a href="https://henriquemartins.net/teaching/financial_strategy/module8/p8tf.html" target="_blank"
  ...
  <a href="https://henriquemartins.net/teaching/financial_strategy/module8/p8num.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    🔢 Numeric Questions
  </a>

  <a href="https://henriquemartins.net/teaching/financial_strategy/module8/p8mcq.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    📝 Multiple Choice
  </a>

  <a href="https://henriquemartins.net/teaching/financial_strategy/module8/p8long.html" target="_blank"
     style="text-decoration: none; width: 75%; background: white; color: #2c3e50; font-weight: bold; text-align: center; padding: 16px; border-radius: 10px; box-shadow: 0 3px 6px rgba(0,0,0,0.2);">
    ✍️ Long-form Answers
  </a>
