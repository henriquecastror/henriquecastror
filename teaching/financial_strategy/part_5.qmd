...
format:
  revealjs: 
    ...
    css: logo.css
    footer: ' **[**Henrique C. Martins**] [[henrique.martins@fgv.br](mailto:henrique.martins@fgv.br)] [[Teaching Resources](https://henriquemartins.net/teaching/)] [[Comments](https://henriquemartins.net/teaching/financial_strategy/part_5.html#/comments)]** '
    multiplex: true
    scrollable: true
...
- Examples of an opportunity to profit at expense of others (maybe). 
...
**Final recommendation: the evidence seems to support the CAPM prediction to "hold the market". Beating the market should require special skills or lower trading costs, which individual investors don't have.**
...
- **SMB**: small-minus-big  portfolio
  - A strategy that each year buys a portfolio of small stocks and sells a portfolio of big stocks.

- **HML**: high-minus-low
  - A trading strategy that each year buys an equally weighted portfolio of stocks with a book-to-market ratio less than the 30th percentile of NYSE firms and finances this position by short selling an equally weighted portfolio of stocks with a book-to-market ratio greater than the 70th percentile of NYSE stocks.
...
- Describe the effect of homogeneous expectations on a security’s alpha.

- Explain why holding the market portfolio does not depend on the quality of an investor’s information or trading skills.

- Understand what the CAPM requires about investors’ expectations.

- Evaluate under what conditions the market portfolio would be inefficient.

- Explain the biases discussed 
...
- Discuss how systematic behavioral biases may affect the efficiency of the market portfolio.
...
<iframe height="60%" width="100%" src="https://hcm.quarto.pub/p5q1/"> </iframe>
...
data-lyket-id="p5q1easy" 
data-lyket-show-counter-from="1" 
data-lyket-namespace="EFPART5" 
...
<iframe height="60%" width="100%" src="https://hcm.quarto.pub/p5q2/"> </iframe>
...
<iframe height="60%" width="100%" src="https://hcm.quarto.pub/p5q3/"> </iframe>
...
<script src="https://giscus.app/client.js"
        data-repo="henriquecastror/efcomments-part-5"
        data-repo-id="R_kgDOK8BRog"
        data-category-id="DIC_kwDOK8BRos4Cb47D"
